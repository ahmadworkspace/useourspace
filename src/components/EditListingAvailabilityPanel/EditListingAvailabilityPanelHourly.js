...
//////////////////////////////////
const EditListingAvailabilityPanelHourly = props => {
    const {
        className,
        rootClassName,
        listing,
...
EditListingAvailabilityPanelHourly.defaultProps = {
    className: null,
    rootClassName: null,
    listing: null,
    availabilityExceptions: [],
...
EditListingAvailabilityPanelHourly.propTypes = {
    className: string,
...
export default EditListingAvailabilityPanelHourly;
