...
import { Inputs } from '../FieldTextInput/FieldTextInput.example';

const FieldSelectComponent = props => {
  const { rootClassName, className, id, label, input, meta, onChange, children, ...rest } = props;
  ...
  return (
    <div className={classes}>
      ...
      <select  {...selectProps}  onClick={(e) => localStorage.setItem('value', e.target.value) }>{children}</select>
